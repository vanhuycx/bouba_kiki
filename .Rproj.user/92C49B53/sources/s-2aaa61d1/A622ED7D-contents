window.jsPsych = (function() {
  ...
  core.init = function(options) {
    function init() {
      ...
      // change beforeunload to unload to test bouba_kiki
      window.addEventListener('beforeunload', opts.on_close);
      
      //window.addEventListener('unload', opts.on_close);
  ...
  module.getKeyboardResponse = function(parameters) {
    ...
    var listener_function = function(e) {
      ...
      if (typeof parameters.valid_responses === 'undefined'){
        ...
        if(parameters.valid_responses.includes(e.code)){
          valid_response = true;
        }
// jdusenberry - this may be broken with change to code
        if(!case_sensitive) {
          var valid_lower = parameters.valid_responses.map(function(v) {return v.toLowerCase();});
          var key_lower = e.code.toLowerCase();
      ...
      if (((typeof parameters.allow_held_key === 'undefined') || !parameters.allow_held_key) && valid_response) {
        ...
        if (!case_sensitive && typeof held_keys[e.code.toLowerCase()] !== 'undefined' && held_keys[e.code.toLowerCase()] == true) {
          valid_response = false;
        }
      }
